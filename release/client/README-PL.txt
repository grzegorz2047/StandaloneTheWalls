SUNDERFRONT 0.1.0-alpha.4 — TECHNICZNY KLIENT JVM
===================================================
...
- Połączenie z localhost nie działa: operator serwera powinien użyć kompletnej
  paczki serwera alpha.4, uruchomić 1_GENERUJ_CREDENTIALS.bat, a następnie
  2_URUCHOM_SERWER.bat. Samo uruchomienie bin\sunderfront-server.bat bez
  konfiguracji startuje proces z wyłączonym TLS i lobby, do którego klient nie
  może się połączyć.
