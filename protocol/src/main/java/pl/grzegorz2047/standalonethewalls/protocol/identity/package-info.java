 ...
 * implement TLS, QUIC, DTLS, certificate issuance, secure-channel exporter generation,
 * local/global nickname authorization, or private-key persistence. See ADR 0003 for player
 * identity, ADR 0004 for server identity/channel binding, and issue #34 for the transport adapter.
 */
