 ...
 * tracked active leases with bounded, failure-preserving shutdown. It intentionally stops at an
 * authenticated `AcceptedTlsConnection`: session UUID bootstrap, runtime command delivery, public
 * PKI, reconnect, realtime DTLS, persistence and production certificate provisioning remain
 * separate work.
 */
