 ...
 * enforces count and byte admission limits, permits one receive, and terminates its executor through
 * an asynchronous bounded close. It does not implement runtime listener ownership, public PKI,
 * realtime DTLS, persistence, certificate provisioning, reconnect, or automatic trust changes.
 */
