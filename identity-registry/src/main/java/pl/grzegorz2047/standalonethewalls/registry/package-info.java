 ...
 * bytes. Verified immutable snapshots can be activated monotonically without a GitHub, network,
 * filesystem, SQLite or UI dependency. Claim authoring, root-transition ceremonies, persistence,
 * download adapters and server authorization modes remain separate work.
 */
