 ...
 * dependency. Verification establishes trustworthy registry state but does not itself authorize a
 * player to join. Claim authoring, root-transition ceremonies, persistence, download adapters and
